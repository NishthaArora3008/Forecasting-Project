...
myseries <- aus_retail |>
  ...
  filter(`Series ID` == sample(`Series ID`,1)) #random series selected
...
```{r dataquality, include=FALSE}
#plot_missing(myseries)
#skimr::skim(myseries)
```
